...
router.get('/userOrders', auth(permissions.create), orderController.userOrders)
router.get('/getdetails/:id', auth(permissions.getDetails), orderController.orderdetails)
router.get('/admin/userorders/:id', auth(permissions.getuserorders), orderController.userOrdersAdmin)
